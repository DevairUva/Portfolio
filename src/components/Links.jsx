      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <ul>
            ...
            <li className='doc'><a className='doc' href="https://drive.google.com/file/d/1xkoBZJPfFyf_35uA0ZFXqXAPdgMVEJ7O/view?usp=sharing" target='_blank'>Curriculo</a> <i class="fa fa-file-text size-links"></i></li>
          </ul>
          <h5>Pessoais</h5>
          <ul>
