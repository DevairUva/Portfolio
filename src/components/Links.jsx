      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <ul>
            ...
            <li className='doc'><a className='doc' href="https://drive.google.com/file/d/1Kcjw1B6Fjd1zP65IKOJGw2kvZ92gUegW/view?usp=sharing" target='_blank'>Curriculo</a> <i class="fa fa-file-text size-links"></i></li>
          </ul>
          <h5>Pessoais</h5>
          <ul>
